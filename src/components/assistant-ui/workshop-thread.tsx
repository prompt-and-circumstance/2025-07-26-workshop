  ...
  return (
    ...
    >
      <ThreadPrimitive.Viewport className="flex h-full flex-col items-center overflow-y-auto scroll-smooth bg-inherit px-4 pt-8">
        ...
        <div className="sticky bottom-0 mt-3 flex w-full max-w-[var(--thread-max-width)] flex-col items-center justify-end rounded-t-lg bg-background/80 backdrop-blur-sm pb-4">
...
const WorkshopThreadWelcome: FC<{
  title: string;
  description?: string;
  suggestions: Suggestion[];
    ...
    <ThreadPrimitive.Empty>
      <div className="flex w-full max-w-[var(--thread-max-width)] flex-grow flex-col">
        <div className="flex w-full flex-grow flex-col items-center justify-center">
          <h2 className="text-lg font-bold terminal-text bloomberg-orange mb-2">
            {title}
          </h2>
          {description && (
        ...
        <WorkshopThreadWelcomeSuggestions suggestions={suggestions} />
      </div>
    </ThreadPrimitive.Empty>
  );
};
